...
- Si `ads_read` esta listo, un comentario recien recibido puede demorarse unos segundos en aparecer para evitar mostrarlo como organico antes de verificar si pertenece a un anuncio. La espera empieza cuando la app recibe el item, no cuando Meta dice que fue creado. Normalmente se libera despues de una pasada Ads posterior al ingreso; si Ads esta ocupado, puede retenerse hasta 3 minutos como maximo de seguridad.
